...
public class StateExitElementImpl extends ASTWrapperPsiElement implements StateExitElement {

  public StateExitElementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StateVisitor visitor) {
    visitor.visitExitElement(this);
  }
  ...
  @Override
  @NotNull
  public StateExitAttrs getExitAttrs() {
    return findNotNullChildByClass(StateExitAttrs.class);
  }
