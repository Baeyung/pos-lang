...
public class StateIncludeAttrImpl extends ASTWrapperPsiElement implements StateIncludeAttr {

  public StateIncludeAttrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StateVisitor visitor) {
    visitor.visitIncludeAttr(this);
  }
