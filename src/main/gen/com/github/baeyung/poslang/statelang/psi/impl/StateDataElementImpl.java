...
public class StateDataElementImpl extends ASTWrapperPsiElement implements StateDataElement {

  public StateDataElementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StateDataAttrs getDataAttrs() {
    return findNotNullChildByClass(StateDataAttrs.class);
  }
