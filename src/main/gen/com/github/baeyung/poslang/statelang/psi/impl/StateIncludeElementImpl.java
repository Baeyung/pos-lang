...
public class StateIncludeElementImpl extends ASTWrapperPsiElement implements StateIncludeElement {

  public StateIncludeElementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StateIncludeAttrs getIncludeAttrs() {
    return findNotNullChildByClass(StateIncludeAttrs.class);
  }
