...
public class StateStateAttrsImpl extends ASTWrapperPsiElement implements StateStateAttrs {

  public StateStateAttrsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StateVisitor visitor) {
    visitor.visitStateAttrs(this);
  }
  ...
  @Override
  @NotNull
  public List<StateStateAttr> getStateAttrList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StateStateAttr.class);
  }
