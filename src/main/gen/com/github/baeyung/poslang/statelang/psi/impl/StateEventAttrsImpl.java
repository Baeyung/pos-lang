...
public class StateEventAttrsImpl extends ASTWrapperPsiElement implements StateEventAttrs {

  public StateEventAttrsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StateVisitor visitor) {
    visitor.visitEventAttrs(this);
  }
  ...
  @Override
  @NotNull
  public List<StateEventAttr> getEventAttrList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StateEventAttr.class);
  }
